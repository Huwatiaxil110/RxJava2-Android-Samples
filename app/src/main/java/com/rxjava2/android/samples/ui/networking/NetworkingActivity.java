...
public class NetworkingActivity extends AppCompatActivity {
    ...
    */
                ...
                .flatMap(new Function<List<User>, ObservableSource<User>>() { // flatMap - to return users one by one
                    ...
                    public ObservableSource<User> apply(List<User> usersList) throws Exception {
                        for (int i = 0; i < usersList.size(); i++) {
                            Log.e(TAG, usersList.get(i).toString());
                        }
    ...
    public void zcDiy(View view) {
        Log.e(TAG, "-------------- 0 ---------------");
        Observable<List<User>> observer = Rx2AndroidNetworking.get("https://fierce-cove-29863.herokuapp.com/getAllCricketFans")
                .build()
                .getObjectListObservable(User.class);
        if(observer == null){
            Log.e(TAG, "-------------- 1 ---------------");
...
//                });
    ...
    private Observable<List<User>> getZcDiyObservable() {
